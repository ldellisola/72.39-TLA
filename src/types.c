...
/*STRING*/          {TYPE_STRING, TYPE_STRING,  TYPE_STRING,  TYPE_STRING,   TYPE_STRING,   TYPE_UNKOWN,   TYPE_UNKOWN},
...
/*VIDEO  */         {TYPE_UNKOWN, TYPE_STRING,  TYPE_UNKOWN,  TYPE_UNKOWN,   TYPE_UNKOWN,   TYPE_UNKOWN,   TYPE_UNKOWN},
/*AUDIO STREAM  */  {TYPE_UNKOWN, TYPE_STRING,  TYPE_UNKOWN,  TYPE_UNKOWN,   TYPE_UNKOWN,   TYPE_UNKOWN,   TYPE_UNKOWN},
/*VIDEO STREAM */   {TYPE_UNKOWN, TYPE_STRING,  TYPE_UNKOWN,  TYPE_UNKOWN,   TYPE_UNKOWN,   TYPE_UNKOWN,   TYPE_UNKOWN},
            };
